...
function ale_enqueue_styles() {
	...
	wp_register_style( 'general_css', THEME_URL . '/css/style.css');
	wp_register_style( 'display_css', THEME_URL . '/css/display.css');

	wp_enqueue_style('general_css');
	//wp_enqueue_style('display_css');
...
function ale_enqueue_scripts() {
	...
	wp_register_script( 'my_common', THEME_URL . '/js/common.js', '', '', true );
	wp_register_script( 'jq', THEME_URL . '/js/jquery.min.js' , '', '', true );
	wp_register_script( 'slick', '//cdn.jsdelivr.net/jquery.slick/1.6.0/slick.min.js', '', '', true  );
	wp_register_script( 'my_map',  'https://maps.googleapis.com/maps/api/js?key=AIzaSyBN9VqzHdRedeGxyP-1owKg4aDwNjnmW_E', array( 'jquery' ), ALETHEME_THEME_VERSION, true);
